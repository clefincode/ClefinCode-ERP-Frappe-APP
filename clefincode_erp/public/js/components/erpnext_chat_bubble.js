export default class ChatBubble {
  ...
  setup() {
    ...
    let chat_icon = `<img title="Start Chat" src="/assets/clefincode_erp/icons/clefincode-chat.svg" width="50px" height="50px">`;
    ...
    this.closed_inner_html = `
          <div class='chat-bubble-closed chat-bubble ${bubble_visible}'>
              ...
              <img title="Start Chat" src="/assets/clefincode_erp/icons/close.svg"  width="25px" height="25px">
              </span>
          </div>
          `;
    this.$chat_bubble
