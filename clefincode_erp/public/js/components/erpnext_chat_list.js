...
async function get_channels_list(email, limit, offset) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_channels_list",
    args: {
      user_email: email,
      limit: limit,
      offset: offset,
...
async function get_last_message_type(
  ...
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_last_message_type",
    args: {
      room_type: room_type,
...
async function search_in_rooms(email, query) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.search_in_rooms",
    args: {
      user: email,
      query: query,
    },
...
async function search_in_message_content(email, query) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.search_in_message_content",
    args: {
      user: email,
      query: query,
    },
