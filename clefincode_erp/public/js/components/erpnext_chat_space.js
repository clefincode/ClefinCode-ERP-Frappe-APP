...
export default class ChatSpace {
  ...
  async create_direct_channel(content) {
    ...
    let res = await frappe.call({
      method: "clefincode_erp.api.api_1_0_1.api.create_channel",
      args: {
        channel_name: "",
    ...
    if (file_url.startsWith("/files") || file_url.startsWith("/private")) {
      if (is_image(file_name)) {
        ...
        if (word.includes(extension)) {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/docx.png">`
          );
        } else if (excel.includes(extension)) {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/xlsx.png">`
          );
        } else if (pdf.includes(extension)) {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/pdf-red.png">`
          );
        } else if (rar.includes(extension)) {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/rar.png">`
          );
        } else if (powerpoint.includes(extension)) {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/ppt.png">`
          );
        } else {
          $content.append(
            `<img style="height: 32px;margin-right: 8px;" src="/assets/clefincode_erp/images/txt.png">`
          );
        }
  ...
  async set_channel_realtime(targetChannel) {
    ...
    frappe.realtime.on(targetChannel, async function (res) {
      if (res.realtime_type == "create_sub_channel") {
        ...
        let chat_topic_status_icon = `<img title="private topic" src="/assets/clefincode_erp/icons/eye-slash.svg">`;
        if (res.chat_topic_status == "public") {
          chat_topic_status_icon = `<img title="public topic" src="/assets/clefincode_erp/icons/eye.svg">`;
        }
        me.$chat_space
          .find(".mentioned-doctype-section")
          .find(".topic-status")
  ...
  callSetTypingAPI(user, room, isTyping) {
    frappe.call({
      method: "clefincode_erp.api.api_1_0_1.api.set_typing",
      args: {
        user: user,
        room: room,
        is_typing: isTyping,
  ...
  render_mentioned_doctype_section(docname) {
    ...
    let chat_topic_status_icon =
      me.chat_topic_status && me.chat_topic_status == "private"
        ? `<img title="private topic" src="/assets/clefincode_erp/icons/eye-slash.svg">`
        : `<img  title="public topic" src="/assets/clefincode_erp/icons/eye.svg">`;
  ...
  <div class="mentioned-doctype-section">
    <div style="flex:1;margin-left:8px">
      <span><img src="/assets/clefincode_erp/icons/tag.svg"> </span><span class="chat_topic_subject" title="${docname}">${
    ...
    <div> 
      ...
      ${
        this.profile.room_type != "Contributor" && this.profile.is_removed != 1
          ? `
      <span class="edit-chat-topic-subject mr-2" ><img src="/assets/clefincode_erp/icons/edit.svg"></span>
      <span class="remove-topic" ><img src="/assets/clefincode_erp/icons/close.svg"></span>
      `
          : ``
      }
    </div>
    ...
    this.$chat_space.find(".edit-chat-topic-subject").on("click", function () {
      ...
      var d = new frappe.ui.Dialog({
        ...
        primary_action: function () {
          ...
          frappe.call({
            method: "clefincode_erp.api.api_1_0_1.api.set_topic_subject",
            args: {
      ...
      this.$chat_space.find(".topic-status").on("click", function () {
        ...
        var d = new frappe.ui.Dialog({
          ...
          async primary_action() {
            frappe.call({
              method: "clefincode_erp.api.api_1_0_1.api.set_topic_status",
              args: {
                chat_topic: me.chat_topic,
...
async function get_messages(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_messages",
    args: {
      room: room,
...
async function get_contributors(room) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_contributors",
    args: {
      room: room,
    },
  });
...
async function get_sub_channel_members(room, user_email) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_sub_channel_members",
    args: {
      room: room,
      user_email: user_email,
    },
...
async function get_last_active_sub_channel(room) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_last_active_sub_channel",
    args: {
      room: room,
    },
  });
...
async function get_all_sub_channels_for_contributor(
  ...
  const res = await frappe.call({
    type: "GET",
    method:
      "clefincode_erp.api.api_1_0_1.api.get_all_sub_channels_for_contributor",
    args: {
...
async function update_sub_channel_for_last_message(
  ...
  const res = frappe.call({
    type: "POST",
    method:
      "clefincode_erp.api.api_1_0_1.api.update_sub_channel_for_last_message",
    args: {
      user: user,
      user_email: user_email,
...
async function get_last_active(contact_email, user_email) {
  const last_active = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_last_active",
    args: {
...
async function add_reference_doctype(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.add_reference_doctype",
    args: {
...
async function get_topic_info(chat_channel) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_topic_info",
    args: {
      chat_channel: chat_channel,
    },
  });
...
async function create_chat_topic(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.create_chat_topic",
    args: {
      mention_doctypes: mention_doctypes,
      chat_channel: chat_channel,
      last_active_sub_channel: last_active_sub_channel,
...
export async function remove_chat_topic(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.remove_chat_topic",
    args: {
      chat_topic: chat_topic,
      chat_channel: chat_channel,
      last_active_sub_channel: last_active_sub_channel,
...
async function check_if_user_has_permission(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.check_if_user_has_permission",
    args: {
      user_email: user_email,
      chat_topic: chat_topic_space,
...
async function check_if_user_send_request(user_email, chat_topic_space) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.check_if_user_send_request",
    args: {
      user_email: user_email,
      chat_topic: chat_topic_space,
    },
...
async function send_topic_access_request(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.send_topic_access_request",
    args: {
      user_email: user_email,
      chat_topic: chat_topic_space,
      chat_channel: chat_topic_channel,
