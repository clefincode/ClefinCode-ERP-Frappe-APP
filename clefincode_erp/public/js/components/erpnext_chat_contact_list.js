...
async function get_contacts(user_email) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_contacts",
    args: {
...
async function create_group(selected_contacts_list, user, creation_date) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.create_group",
    args: {
...
async function get_contacts_for_adding_to_group(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_contacts_for_adding_to_group",
    args: {
      user_email: user_email,
...
async function add_group_member(new_members, room, last_active_sub_channel) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.add_group_member",
    args: {
