...
function mark_messsages_as_read(user, channel = null, parent_channel = null) {
  frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.mark_messsages_as_read",
    args: {
      user: user,
      channel: channel,
...
async function get_profile_full_name(user_email) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_profile_full_name",
    args: {
...
async function check_if_room_admin(room, email) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.check_if_room_admin",
    args: {
      room: room,
      email: email,
    },
...
async function create_sub_channel(params) {
  ...
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.create_sub_channel",
    args: {
...
async function get_time_now(user_email, formatted = null) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_time_now",
    args: {
      user_email: user_email,
      formatted: formatted,
    },
...
async function get_chat_members(room) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_chat_members",
    args: {
      room: room,
    },
  });
...
async function check_if_contributor_active(channel, user_email) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.check_if_contributor_active",
    args: {
      channel: channel,
      user_email: user_email,
    },
