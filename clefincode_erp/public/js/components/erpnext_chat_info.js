    ...
    this.$chat_info.find(".edit").on("click", function () {
      var d = new frappe.ui.Dialog({
        ...
        primary_action: async function () {
          ...
          await frappe.call({
            method: "clefincode_erp.api.api_1_0_1.api.set_group_name",
            args: {
              room: me.room,
              newname: newname,
            ...
            if (!me.chat_space.chat_topic_subject) {
              var dd = new frappe.ui.Dialog({
                ...
                primary_action: function () {
                  ...
                  frappe.call({
                    method:
                      "clefincode_erp.api.api_1_0_1.api.set_topic_subject",
                    args: {
                      chat_topic: me.chat_space.chat_topic,
...
async function get_room_creator(room) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_room_creator",
    args: {
      room: room,
    },
  });
...
async function get_room_in_common(email1, email2) {
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.get_room_in_common",
    args: {
      email1: email1,
      email2: email2,
    },
...
async function get_links(channel, useremail, remove_date) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_chat_links",
    args: {
      channel: channel,
      useremail: useremail,
...
async function get_media(channel, useremail, remove_date) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_chat_media",
    args: {
      channel: channel,
      useremail: useremail,
      remove_date: remove_date,
...
async function get_docs(channel, useremail, remove_date) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_chat_docs",
    args: {
      channel: channel,
      useremail: useremail,
      remove_date: remove_date,
...
async function remove_group_member(email, room, last_active_sub_channel) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.remove_group_member",
    args: {
      email: email,
      room: room,
...
async function remove_group_member_and_assign_new_admin(
  ...
  const res = await frappe.call({
    method:
      "clefincode_erp.api.api_1_0_1.api.remove_group_member_and_assign_new_admin",
    args: {
      email: email,
      room: room,
...
async function get_room_admins(room, email) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_room_admins",
    args: {
      room: room,
      email: email,
    },
...
async function is_member(room) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.are_members",
    args: {
      room: room,
    },
  });
...
async function disable_contributors(
  ...
  const res = await frappe.call({
    type: "GET",
    method: "clefincode_erp.api.api_1_0_1.api.disable_contributors",
    args: {
...
async function leave_contributor(params) {
  ...
  await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.leave_contributor",
    args: {
      parent_channel: parent_channel,
      user: user,
...
async function remove_reference_doctype(
  ...
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.remove_reference_doctype",
    args: {
...
async function get_topic_contributors(chat_topic) {
  const res = await frappe.call({
    method: "clefincode_erp.api.api_1_0_1.api.get_topic_contributors",
    args: {
      chat_topic: chat_topic,
    },
  });
